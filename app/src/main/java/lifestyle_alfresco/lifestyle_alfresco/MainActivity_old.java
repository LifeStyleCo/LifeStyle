    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent_about = new Intent(MainActivity_old.this, AboutActivity.class);
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    ...
                    case R.id.nav_profile:
                        Intent intent_profile = new Intent(MainActivity_old.this, ProfileActivity.class);
                        startActivity(intent_profile);
                        break;
                    case R.id.nav_settings:
                        Intent intent_settings = new Intent(MainActivity_old.this, SettingsActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_settings:
                Intent intent_settings2 = new Intent(MainActivity_old.this, SettingsActivity.class);
